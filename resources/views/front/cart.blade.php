...
<script>
  ...
  function updateCart(rowId, qty) { // إصلاح تعريف الدالة
      $.ajax({
          url: '{{ route("front.updateCart") }}',
          type: 'post',
          data: { rowId: rowId, qty: qty }, // استخدام المعامل الصحيح
          dataType: 'json',
          success: function(response) {
              // أضف كود المعالجة هنا عند الحاجة
  ...
  function deleteItem(rowId) {
      if(confirm("Are you want to delete?")){
          $.ajax({
        url: '{{ route("front.deleteItem.cart") }}', // تأكد من استخدام المسار الصحيح للحذف
        type: 'post',
        data: { rowId: rowId }, // أرسل فقط معرّف العنصر للحذف
        dataType: 'json',
        success: function(response) {
            if (response.status) {
                ...
                // في حالة فشل الحذف، يمكن إضافة رسالة للمستخدم
